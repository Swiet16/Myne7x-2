...
const AdminSidebar = ({ activeTab, onTabChange, isDarkMode, onThemeToggle }: AdminSidebarProps) => {
  ...
  const menuItems = [
    ...
    { id: 'refunds', label: 'Refunds', icon: RefreshCw, description: 'Refund Requests' },
    { id: 'contacts', label: 'Contacts', icon: MessageCircle, description: 'Contact Requests' },
    ...
    { id: 'team', label: 'Team', icon: UsersRound, description: 'Team Management' },
    { id: 'website-animation', label: 'Animations', icon: Sparkles, description: 'Website Animations' },
