...
const Contact = () => {
  ...
  // Use dynamic contact details or fallback to defaults
  const displayEmail = contactDetails?.email || "myne7x@gmail.com";
  const displayPhone = contactDetails?.phone_number || "+92 309 6626615";
  const displayAddress = contactDetails?.address || "Digital Innovation Center, Karachi, Pakistan";
  ...
  const contactMethods = [
    ...
    },
    {
      ...
      action: `https://wa.me/${displayPhone.replace(/[^0-9]/g, '')}`,
    ...
    },
    {
      ...
      contact: displayPhone,
      action: `tel:${displayPhone.replace(/[^0-9]/g, '')}`,
        ...
        <section className="mb-20">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {contactMethods.map((method, index) => (
              <Card key={index} className="card-neon text-center group cursor-pointer slide-in-up hover:scale-105 transition-all duration-300" style={{ animationDelay: `${index * 0.1}s` }}>
                <CardHeader>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                      ...
                      <Input
                        ...
                        required
                        className="mt-2 bg-background/50 border-primary/30 text-foreground placeholder:text-muted-foreground/60"
                      />
                    </div>
                    <div>
        ...
        <section className="mb-20">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-6xl mx-auto">
            {faqItems.map((item, index) => (
              <Card key={index} className="card-neon slide-in-up hover:scale-105 transition-all duration-300" style={{ animationDelay: `${index * 0.1}s` }}>
                <CardHeader>
          ...
          <Card className="card-neon bg-gradient-hero text-center">
            <CardContent className="p-12">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <a href={`https://wa.me/${displayPhone.replace(/[^0-9]/g, '')}`} target="_blank" rel="noopener noreferrer">
